...
import Ps5 from "../NavBar/NavIcons/Ps5";
import XBOXX from "../NavBar/NavIcons/XBOX-X";
import Ps4 from "../NavBar/NavIcons/Ps4";
import NINTENDOSWITCH from "../NavBar/NavIcons/NintendoSwitch";
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y font-serif divide-slate-300 rounded-md bg-slate-50 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            <div className="px-1 py-1 ">
                ...
                <NavLink to="/category/PS5">
                  <div className="text-slate-600 hover:text-slate-50 hover:bg-indigo-400/70 group flex flex-row w-full items-center rounded-md px-2 py-2 text-sm">
                    <button className="flex">
                      <Ps5 className={"ml-1 mr-2 text-indigo-600"} />
                      PS5
                    </button>
                  </div>
                </NavLink>
              ...
              <Menu.Item>
                <NavLink to="/category/XBOXX">
                  <div className="text-slate-600 hover:text-slate-50 hover:bg-indigo-400/70 group flex flex-row w-full items-center rounded-md px-2 py-2 text-sm">
                    <button className="flex">
                      <XBOXX className={"ml-1 mr-2 text-indigo-600"} />
                      XBOX Serie X
                    </button>
                  </div>
                </NavLink>
              ...
              <Menu.Item>
                <NavLink to="/category/NINTENDOSWITCH">
                  <div className="text-slate-600 hover:text-slate-50 hover:bg-indigo-400/70 group flex flex-row w-full items-center rounded-md px-2 py-2 text-sm">
                    <button className="flex">
                      <NINTENDOSWITCH className={"ml-1 mr-2 text-indigo-600"} />
                       NINTENDO SWITCH
                    </button>
                  </div>
                </NavLink>
              ...
              <Menu.Item>
                <NavLink to="/category/PS4">
                  <div className="text-slate-600 hover:text-slate-50 hover:bg-indigo-400/70 group flex flex-row w-full items-center rounded-md px-2 py-2 text-sm">
                    <button className="flex">
                      <Ps4 className={"ml-1 mr-2 text-indigo-600"} />
                      PS4
                    </button>
                  </div>
                </NavLink>
